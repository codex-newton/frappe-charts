...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/frappe-charts/dist/frappe-charts.esm.js":[function(require,module,exports) {
"use strict";
...
const getColor = color => {
  ...
  if (/rgb[a]{0,1}\([\d, ]+\)/gim.test(color)) {
    return /\D+(\d*)\D+(\d*)\D+(\d*)/gim.exec(color).map((x, i) => i !== 0 ? Number(x).toString(16) : '#').reduce((c, ch) => `${c}${ch}`);
  }
...
class AggregationChart extends BaseChart {
  ...
  renderLegend() {
    ...
    this.legendTotals.map((d, i) => {
      ...
      let dot = legendDot(x, y, 5, this.colors[i], `${label}: ${formatted}`, false);
...
exports.Chart = Chart;
},{}],"pie.js":[function(require,module,exports) {
"use strict";

var _frappeChartsEsm = require("frappe-charts/dist/frappe-charts.esm.js");
new _frappeChartsEsm.Chart("#chart", {
  // or DOM element
  data: {
    ...
    datasets: [{
      name: "Net Worth",
      chartType: "line",
      values: [828340, 1892712, 22881363, 50338998, 18054239, 16210847, 22010847, 18108478]
    }],
    yMarkers: [{
      label: "USD",
      value: 1,
...
},{"frappe-charts/dist/frappe-charts.esm.js":"node_modules/frappe-charts/dist/frappe-charts.esm.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41457" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","pie.js"], null)
//# sourceMappingURL=/pie.c6584535.js.map